import { Card, CardHeader, CardTitle, Pill, Stat } from "../../dls";
...
// Keeps the same markers off the critical path while data loads.
    ...
    <div className="account-strip">
      {[0, 1, 2].map((i) => (
        <Card key={i}>
          ...
          <div className="empty-state" style={{ minHeight: "var(--space-8)" }} />
        </Card>
      ))}
    </div>
  );
